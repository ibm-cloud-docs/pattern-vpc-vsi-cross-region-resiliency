...
Update Table below with components unique to this architecture. Introduce the table with a sentence. For example: "The following table outlines the products used in the architecture for each aspect."
